...
(() =>{
       ...
       document.addEventListener("click", (event) =>{
          if(event.target.classList.contains('link-item')){
                 /* make sure event .traget.hash has a value befor overridding default*/
...
(() =>{
     ...
     function popupSlideshow(){
            ...
            /*activate loader unitl the  popupImg loaded */
            ...
            popup.querySelector(".pp-counter").innerHTML = (slideIndex+1) + " 0f " + screenshots.length;
     }
     //next slide
     ...
     function popupDetails(){
            ...
            // get the project titile
            const title = portfolioItems[itemIndex].querySelector(".portfolio-item-title").innerHTML;
            // set the project title
            popup.querySelector(".pp-title h2").innerHTML = title;
            //get the project category
            const category = portfolioItems[itemIndex].getAttribute("data-category");
            //set the the project category
